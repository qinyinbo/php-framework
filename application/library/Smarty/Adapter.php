...
require_once SMARTY_SYSPLUGINS_DIR . "smarty_internal_compile_block.php";
...
class Smarty_Adapter implements Yaf_View_Interface
{
    ...
    public function __construct($tmplPath = null, $extraParams = array()) {
        ...
        $path = Yaf_Registry::get("config")->application->smarty->template_dir;
        if (Yaf_Registry::get('https')) {
            $path = Yaf_Registry::get("config")->application->smarty->https_template_dir;
        }
        $path .= '/plugins/';
        ...
        foreach ($extraParams as $key => $value) {
            if (in_array($key, array('https_template_dir', 'https_compile_dir'))) {
                continue;
            }
            if (Yaf_Registry::get('https')) {
                if (in_array($key, array('template_dir', 'compile_dir'))) {
                    $nkey = 'https_' . $key;
                    $value = $extraParams[$nkey];
                }
            }
